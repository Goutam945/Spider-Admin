...
public class Act_Login_screen extends AppCompatActivity {
    Context context;
    Activity activity;
...
//                Log.d("Android","Android ID : "+device_id);
    ...
    private void api_login() throws JSONException {
        ...
        baseRequest.setBaseRequestListner(new RequestReciever() {
            ...
            public void onFailure(int requestCode, String errorCode, String message) {
                Toast.makeText(Act_Login_screen.this, message, Toast.LENGTH_SHORT).show();
            }
    ...
    {
        Dialog mDialog = new Dialog(Act_Login_screen.this);
        mDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);  //without extar space of title
